...
\input{section1_sliding_windows}

\input{section2_convexhull}

\input{section3_monge}

\input{section4_knuth}

\input{section5_dc}

\input{section6_smawk}

\input{section7_aliens}
